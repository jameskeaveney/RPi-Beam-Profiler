...
d_midblue = [145.0 / 255, 184.0 / 255.0, 189.0 / 255.0]  # 	Mid Blue			5493C
...
d_lightblue = [196.0 / 255, 229.0 / 255.0, 250.0 / 255.0]  # 	Light Blue			290C
d_pink = [196.0 / 255.0, 59.0 / 255.0, 142.0 / 255.0]  #  	Pink				675C
d_grey = [150.0 / 255, 142.0 / 255, 133.0 / 255]  # 	Warm Grey			8C
d_black = [35.0 / 255, 31.0 / 255, 32.0 / 255]  # 	Black				BlackC
d_lightgrey = [207.0 / 255, 218.0 / 255, 209.0 / 255]  # 	Near White/L. Grey	5655C
d_midgrey = [110.0 / 255, 100.0 / 255, 100.0 / 255]
...
def help_dcols():
    ...
    from pylab import clf, figure, show, subplots
